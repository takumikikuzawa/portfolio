...
if(isset($_POST['submit'])) {
    ...
    if(trim($_POST['contact']) === '') {
        $contactError = 'お問い合わせ内容が入力されていません';
        $hasError = true;
    } else {
...
<body>
	...
	<header class="header">
		...
		<p class="header-logo"><a href="complete.php">TAKUMI KIKUZAWA</a></p>
	...
	<section id="work" class="inner">
		...
		<div id="dayservice" class="modaal hide-area">
			...
			<figure class="modaal__img">
				<img src="images/dayservice.png" alt="架空の介護ホームページのデザインカンプトップページ">
			</figure>
		...
		<div id="ayurveda" class="hide-area">
			...
			<figure class="modaal__img">
				<img src="images/ayuveda.png" alt="架空の個人事業ホームページのデザインカンプトップページ">
			</figure>
			<p class="modaal__content">
		...
		<div id="hairwithcafe" class="hide-area">
			...
			<figure class="modaal__img">
				<img src="images/hairwithcafe.png" alt="架空の美容室ホームページのデザインカンプトップページ">
			</figure>
			<p class="modaal__content">
		...
		<div id="portfolio" class="hide-area">
			...
			<figure class="modaal__img">
				<img src="images/portfolio.png" alt="ポートフォリオサイトのデザインカンプ>
			</figure>
			<p class="modaal__content">
	...
	<section id="skill" class="inner">
		...
		<div class="skill__inner">
			...
			<div class="skill__wrap fadeout5">
				...
				<figure class="skill__img" alt="携帯のイラスト">
	...
	<section id="contact" class="inner">
		<h2 class="contact__heading-lv2 contact__complete">
			<div class="fadeout bubble">
				<span>C</span><span>O</span><span>N</span><span>T</span><span>A</span><span>C</span><span>T</span>
			</div>
		</h2>
		<figure class="submarine2">
			<img src="images/submarine.png" alt="潜水艦のイラスト">
		</figure>
		<div class="contact fadeout4">
			<h3 class=contact__heading-lv3>お問い合わせ完了</h3>
			<p class="contact__submitted">
			確認のメールを送付させて頂いております。<br>
			お問い合わせありがとうございました。</p>
		</div>
